...
const COMMANDS: { name: string; description: string; tag?: string }[] = [
	...
	},
	{
		...
		description:
			"Submit an extra request for review. Files can be attached.",
		tag: "DEV",
	},
	{
...
const LINK_BUTTONS: { name: string; link: string }[] = [
	{
		name: "View Guidelines (v3.0)",
		link: "https://drive.google.com/file/d/1dwJHs0ghmGtOynGFxhhBb1CulixVuAGY/view?usp=sharing",
	},
	{
		name: "Tool Submission Tutorial",
		link: "https://www.youtube.com/watch?v=X2out-3ml8Q",
	},
...
const ACTION_BUTTONS: { name: string; customId: string }[] = [
	{
		name: "Request Property File",
		customId: "modal-dev_request_property_modal",
	},
	{
		name: "Submit Property File",
		customId: "modal-dev_submit_property_modal",
	},
	{ name: "Make Extra Request", customId: "modal-dev_request_extra_modal" },

	{
		name: "New Property Activity",
		customId: "modal-blm_property_activity_modal",
	},
	{
		name: "New Property Aquisition",
		customId: "modal-blm_property_request_modal",
	},
];
