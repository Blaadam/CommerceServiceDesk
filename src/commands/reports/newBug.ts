...
export default class ViewHistoryCommand extends Command {
	...
	public async chatInputRun(interaction: ChatInputCommandInteraction) {
		...
		const textDisplayLabel = new TextDisplayBuilder().setContent(
			"This modal is used to receive feedback for bug fixes. Please provide as much detail as possible to help us understand your report.",
		);
		...
		const descLabel = new LabelBuilder()
			...
			.setTextInputComponent(
				new TextInputBuilder()
					.setCustomId("bugDesc")
					.setPlaceholder(
						"Enter a description of the bug, including steps to reproduce it",
					)
