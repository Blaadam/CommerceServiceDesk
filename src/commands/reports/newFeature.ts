...
export default class ViewHistoryCommand extends Command {
	...
	public async chatInputRun(interaction: ChatInputCommandInteraction) {
		...
		const textDisplayLabel = new TextDisplayBuilder().setContent(
			"This modal is used to receive feedback for new features. Please provide as much detail as possible to help us understand your request.",
		);
		...
		const descLabel = new LabelBuilder()
			...
			.setTextInputComponent(
				new TextInputBuilder()
					...
					.setPlaceholder(
						"Enter a description of the feature, including use cases and how it would work",
					)
